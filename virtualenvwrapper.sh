...
echo "------------------------------"
echo "Source virtualenvwrapper from /Users/local/dein-dev/.extra"
...
echo "export WORKON_HOME=/Users/local/dein-dev/.ssh/.stack/.dotfiles-and-directories/.virtualenvs" >> $EXTRA_PATH
echo "source /Users/local/dein-dev/.ssh/.stack/.dotfiles-and-directories/.virtualenvs/virtualenvwrapper.sh" >> $EXTRA_PATH
echo "export PATH="/Users/local/dein-dev/bin:$PATH"" >> $BASH_PROFILE_PATH
source $EXTRA_PATH
